...
lazy val libAvro4s                 = "com.sksamuel.avro4s"   %% "avro4s-core"              % "4.0.5"
...
lazy val libKafkaStreamsAvroSerde  = "io.confluent"          %  "kafka-streams-avro-serde" % "6.1.1"
lazy val libPureConfig             = "com.github.pureconfig" %% "pureconfig"               % "0.15.0"
